namespace MetroExplorer.Core
{
    ...
    public static class UIElementAnimationExtensions
    {
        ...
        /// <returns></returns>
        public static void FadeInCustom(this UIElement element, TimeSpan? duration = null, EasingFunctionBase easingFunction = null, double targetOpacity = 1.0)
        {
